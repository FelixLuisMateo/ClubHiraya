...
?>>
    ...
    <main class="main-content" role="main" aria-label="Main content">
        ...
        <div class="topbar">
            ...
            <a class="select-table-btn" role="link" href="Cabins/Cabins.php">
                Select Cabins <span class="table-icon"><img src="assets/logos/table.png" alt=""></span>
            </a>
        </div>
