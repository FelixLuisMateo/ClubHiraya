...
?>>
    ...
    <aside class="sidebar" role="complementary" aria-label="Sidebar">
        <div class="sidebar-header">
            <img src="../ClubHirayaFinal/assets/logos/logo1.png" alt="Club Hiraya logo" class="sidebar-header-img">
        </div>
        ...
        <nav class="sidebar-menu" role="navigation" aria-label="Main menu">
            ...
            <a href="../ClubHirayaFinal/inventory/inventory.php" class="sidebar-btn">
                <span class="sidebar-icon"><img src="../ClubHirayaFinal/assets/logos/inventory.png" alt="Inventory icon"></span>
                <span>Inventory</span>
            </a>
            <a href="php/../SalesReport/sales_report.php" class="sidebar-btn">
                <span class="sidebar-icon"><img src="../ClubHirayaFinal/assets/logos/sales.png" alt="Sales report icon"></span>
                <span>Sales Report</span>
            </a>
            <a href="../ClubHirayaFinal/settings/settings.php" class="sidebar-btn">
                <span class="sidebar-icon"><img src="../ClubHirayaFinal/assets/logos/setting.png" alt="Settings icon"></span>
                <span>Settings</span>
            </a>
        </nav>
    ...
    <main class="main-content" role="main" aria-label="Main content">
        ...
        <div class="topbar">
            ...
            <a class="select-table-btn" role="link" href="../ClubHirayaFinal/Cabins/Cabins.php">
                Select Cabins <span class="table-icon"><img src="../ClubHirayaFinal/assets/logos/table.png" alt=""></span>
            </a>
        </div>
