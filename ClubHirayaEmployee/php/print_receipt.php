...
if ($cartJson === null) {
    ...
    <body>
      <div class="card">
        ...
        <p><a class="button" href="employee_dashboard.php">Back to POS</a></p>
      </div>
    </body>
    </html>
    <?php
...
<body>
  ...
  <div class="controls no-print">
    ...
    <a id="backToPos" class="btn btn-back" href="employee_dashboard.php" onclick="event.preventDefault(); returnToPOS();">Back to POS</a>
